...
def get_navigation_items(role_or_path=None, db=None, user_role=None) -> list:
    ...
    all_navigation = [
        {"name": "Дашборд", "url": "/admin/", "icon": "fas fa-chart-line", "roles": ["owner", "admin", "sales", "executor"]},
        {"name": "Клиенты", "url": "/admin/clients", "icon": "fas fa-address-book", "roles": ["owner", "admin", "sales"]},
        {"name": "Лиды", "url": "/admin/leads", "icon": "fas fa-user-check", "roles": ["owner", "admin", "sales"]},
        {"name": "Сделки", "url": "/admin/deals", "icon": "fas fa-handshake", "roles": ["owner", "admin", "sales"]},
        {"name": "Авито", "url": "/admin/avito", "icon": "fas fa-comments", "roles": ["owner", "admin", "sales"]},
        {"name": "Проекты", "url": "/admin/projects", "icon": "fas fa-project-diagram", "roles": ["owner", "admin", "sales", "executor"]},
        ...
        {"name": "Мои задачи", "url": "/admin/tasks/user/my-tasks", "icon": "fas fa-clipboard-list", "roles": ["owner", "admin", "sales", "executor"]},
