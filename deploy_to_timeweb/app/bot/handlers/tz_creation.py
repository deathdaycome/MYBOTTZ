...
class TZCreationHandler:
    ...
    TZ_METHOD, TZ_TEXT_INPUT, TZ_VOICE_INPUT, TZ_STEP_BY_STEP, TZ_FILE_UPLOAD, TZ_REVIEW, TZ_EDIT = range(7)
...
Проект добавлен в ваш список. Теперь нужно подготовить хостинг для вашего бота.

🚀 <b>Следующий шаг:</b> Регистрация хостинга

<b>Почему нужен хостинг?</b>
• Ваш бот должен работать 24/7
• Нужен сервер для размещения кода
• Требуется база данных для хранения информации
• Timeweb - надежный российский хостинг-провайдер

💡 <b>Выгодные условия:</b>
• Первые 3 дня бесплатно
• Скидка 15% по нашей ссылке
• Техподдержка 24/7
• Простая настройка
            """
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [
                    InlineKeyboardButton("✅ Уже зарегистрирован", callback_data=f"timeweb_registered_{project_id if project else 0}"),
                    InlineKeyboardButton("❓ Что это?", callback_data="timeweb_info")
                ],
                [
